//--------------------------------------------------------------------------------------------------
// Transparent ghost material (rev 4)
//--------------------------------------------------------------------------------------------------
#ifdef _3DSMAX_
...
float 	 SilhouetteMin 					: SilhouetteMin			< string UIName = "Min Silhouette Angle";  > = 0.7f;
float 	 SilhouetteMax 					: SilhouetteMax			< string UIName = "Max Silhouette Angle";  > = 0.9f;
float3	 SilhouetteColor				: SilhouetteColor		< string UIName = "Silhouette Color";  > = {1.0f, 1.0f, 1.0f};

float 	 SilhouetteDiffuseIntensity		: SilhouetteDiffuseIntensity	< string UIName = "Silhouette Base Diffuse Intensity";  > = 1.0f;
float 	 SilhouetteModulateIntensity	: SilhouetteModulateIntensity	< string UIName = "Silhouette Diffuse Intensity";  > = 1.0f;
float 	 SilhouetteColorIntensity		: SilhouetteColorIntensity		< string UIName = "Silhouette Color Intensity";  > = 1.0f;
...
struct VS_OUTPUT
{
	...
	float3 viewNormal		: TEXCOORD3;	// Vertex normal (in view space)
};
...
VS_OUTPUT vs(VS_INPUT vIn)
{
	...
	Out.vertexToEye = cameraPosition - Out.worldPos;
