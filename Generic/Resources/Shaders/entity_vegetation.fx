//--------------------------------------------------------------------------------------------------
// Final pass for vegetation material (rev 1)
//--------------------------------------------------------------------------------------------------
...
Texture2D 	ShadowMap;
SamplerState bilinear_wrap_sampler 
{
...
//--------------------------------------------------------------------------------------------------
#if SH_DX11
void vs(VS_SKIN_INPUT vIn, out float4 position : POSITION, out VS_OUTPUT Out)
#else
...
#if SH_DX11
void vs_skin(VS_SKIN_INPUT vIn, out float4 position : POSITION, out VS_OUTPUT Out)
#else
...
#define PS_NAME		ps0
#include "entity_vegetation_macrops.fxh"
#undef PS_NAME
#undef FEATURE_FLAGS
